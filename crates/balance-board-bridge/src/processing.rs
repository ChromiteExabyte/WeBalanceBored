#[cfg(test)]
use balance_board_protocol::{BoardReport, Calibration};
...
fn process_report(
    ...
    process_weights(kg, report.buttons.balance_board_button(), tare, filter)
}

pub(crate) fn process_weights(
    kg: CalibratedSensors,
    button: bool,
    tare: (f32, f32),
    filter: &mut LowPass2D,
) -> Processed {
